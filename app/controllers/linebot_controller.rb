  ...
  def callback
    ...
    events.each { |event|
      if event.message['text'] != nil
        ...
        result = curl -X GET http://api.gnavi.co.jp/RestSearchAPI/20150630/?keyid=3fa92180d46259a9942d63e66ffe5e11format=json&address="#{place}"#ここでぐるなびAPIを叩く
      else
        latitude = event.message['latitude']
        longitude = event.message['longitude']

        result = curl -X GET http://api.gnavi.co.jp/RestSearchAPI/20150630/?keyid=3fa92180d46259a9942d63e66ffe5e11format=json&latitude="#{latitude}"&longitude="#{longitude}"#ここでぐるなびAPIを叩く
      end
